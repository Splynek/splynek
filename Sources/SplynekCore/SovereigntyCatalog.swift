...
enum SovereigntyCatalog {
    ...
    static let entries: [Entry] = [
        ...
        Entry(targetBundleID: "com.microsoft.outlook",
              ...
              alternatives: [
                .init(id: "outlook:thunderbird", origin: .oss,
                      ...
                      downloadURL: URL(string: "https://download.mozilla.org/?product=thunderbird-latest&os=osx&lang=en-US")),
        ...
        // ─── Browsers (expanded) ──────────────────────────────────
        Entry(targetBundleID: "company.thebrowser.Browser",
              targetDisplayName: "Arc",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "arc:firefox", origin: .oss,
                      name: "Firefox", homepage: URL(string: "https://www.mozilla.org/firefox")!,
                      note: "Mozilla Foundation (MPL).",
                      downloadURL: URL(string: "https://download.mozilla.org/?product=firefox-latest&os=osx&lang=en-US")),
                .init(id: "arc:vivaldi", origin: .europe,
                      name: "Vivaldi", homepage: URL(string: "https://vivaldi.com")!,
                      note: "Norway. Workspace-oriented browser."),
              ]),
        Entry(targetBundleID: "com.operasoftware.Opera",
              targetDisplayName: "Opera",
              targetOrigin: .china,   // Majority-owned by Chinese consortium (Kunlun / 360) since 2016
              alternatives: [
                .init(id: "opera:firefox", origin: .oss,
                      name: "Firefox", homepage: URL(string: "https://www.mozilla.org/firefox")!,
                      note: "Mozilla Foundation (MPL).",
                      downloadURL: URL(string: "https://download.mozilla.org/?product=firefox-latest&os=osx&lang=en-US")),
                .init(id: "opera:vivaldi", origin: .europe,
                      name: "Vivaldi", homepage: URL(string: "https://vivaldi.com")!,
                      note: "Norway. Founded by ex-Opera team."),
              ]),

        // ─── Mail / calendar ──────────────────────────────────────
        Entry(targetBundleID: "com.superhuman.electron",
              targetDisplayName: "Superhuman",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "superhuman:protonmail", origin: .europe,
                      name: "Proton Mail", homepage: URL(string: "https://proton.me/mail")!,
                      note: "Proton AG (Switzerland). E2E-encrypted."),
                .init(id: "superhuman:thunderbird", origin: .oss,
                      name: "Thunderbird", homepage: URL(string: "https://www.thunderbird.net")!,
                      note: "MPL. Mozilla-owned.",
                      downloadURL: URL(string: "https://download.mozilla.org/?product=thunderbird-latest&os=osx&lang=en-US")),
              ]),
        Entry(targetBundleID: "com.hey.app",
              targetDisplayName: "HEY",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "hey:protonmail", origin: .europe,
                      name: "Proton Mail", homepage: URL(string: "https://proton.me/mail")!,
                      note: "Switzerland."),
                .init(id: "hey:tutanota", origin: .europe,
                      name: "Tuta", homepage: URL(string: "https://tuta.com")!,
                      note: "Tuta GmbH (Germany). E2E-encrypted."),
              ]),
        Entry(targetBundleID: "notion.id.calendar",
              targetDisplayName: "Notion Calendar",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "notioncal:proton-calendar", origin: .europe,
                      name: "Proton Calendar", homepage: URL(string: "https://proton.me/calendar")!,
                      note: "Switzerland. E2E-encrypted."),
              ]),

        // ─── Tasks / project mgmt ─────────────────────────────────
        Entry(targetBundleID: "com.omnigroup.OmniFocus4",
              targetDisplayName: "OmniFocus",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "of:todoist", origin: .europe,
                      name: "Todoist", homepage: URL(string: "https://todoist.com")!,
                      note: "Doist Inc. (Czech Republic)."),
                .init(id: "of:superproductivity", origin: .oss,
                      name: "Super Productivity", homepage: URL(string: "https://super-productivity.com")!,
                      note: "MIT. Self-hostable task manager."),
              ]),
        Entry(targetBundleID: "com.ticktick.task.mac",
              targetDisplayName: "TickTick",
              targetOrigin: .china,
              alternatives: [
                .init(id: "tt:todoist", origin: .europe,
                      name: "Todoist", homepage: URL(string: "https://todoist.com")!,
                      note: "Czech Republic."),
                .init(id: "tt:things", origin: .europe,
                      name: "Things", homepage: URL(string: "https://culturedcode.com/things/")!,
                      note: "Cultured Code (Germany). Paid, one-time."),
              ]),
        Entry(targetBundleID: "com.microsoft.to-do-mac",
              targetDisplayName: "Microsoft To Do",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "mstodo:todoist", origin: .europe,
                      name: "Todoist", homepage: URL(string: "https://todoist.com")!,
                      note: "Czech Republic."),
                .init(id: "mstodo:superproductivity", origin: .oss,
                      name: "Super Productivity", homepage: URL(string: "https://super-productivity.com")!,
                      note: "MIT."),
              ]),
        Entry(targetBundleID: "com.asana.Asana",
              targetDisplayName: "Asana",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "asana:openproject", origin: .europeAndOSS,
                      name: "OpenProject", homepage: URL(string: "https://www.openproject.org")!,
                      note: "OpenProject GmbH (Germany). GPL. Self-hostable."),
                .init(id: "asana:taiga", origin: .europeAndOSS,
                      name: "Taiga", homepage: URL(string: "https://taiga.io")!,
                      note: "Kaleidos (Spain). Apache. Agile PM."),
              ]),
        Entry(targetBundleID: "com.clickup.desktop-app",
              targetDisplayName: "ClickUp",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "clickup:openproject", origin: .europeAndOSS,
                      name: "OpenProject", homepage: URL(string: "https://www.openproject.org")!,
                      note: "Germany. GPL."),
                .init(id: "clickup:taiga", origin: .europeAndOSS,
                      name: "Taiga", homepage: URL(string: "https://taiga.io")!,
                      note: "Spain. Apache."),
              ]),
        Entry(targetBundleID: "com.trello.trello-desktop-macos",
              targetDisplayName: "Trello",
              targetOrigin: .other,  // Atlassian, Australia
              alternatives: [
                .init(id: "trello:kanboard", origin: .oss,
                      name: "Kanboard", homepage: URL(string: "https://kanboard.org")!,
                      note: "MIT. Minimalist kanban."),
                .init(id: "trello:taiga", origin: .europeAndOSS,
                      name: "Taiga", homepage: URL(string: "https://taiga.io")!,
                      note: "Spain. Apache."),
              ]),
        Entry(targetBundleID: "com.monday.mondayapp",
              targetDisplayName: "monday.com",
              targetOrigin: .other,  // Israel
              alternatives: [
                .init(id: "monday:openproject", origin: .europeAndOSS,
                      name: "OpenProject", homepage: URL(string: "https://www.openproject.org")!,
                      note: "Germany. GPL."),
                .init(id: "monday:taiga", origin: .europeAndOSS,
                      name: "Taiga", homepage: URL(string: "https://taiga.io")!,
                      note: "Spain. Apache."),
              ]),
        Entry(targetBundleID: "com.atlassian.jira",
              targetDisplayName: "Jira",
              targetOrigin: .other,  // Atlassian, Australia
              alternatives: [
                .init(id: "jira:openproject", origin: .europeAndOSS,
                      name: "OpenProject", homepage: URL(string: "https://www.openproject.org")!,
                      note: "Germany. GPL."),
                .init(id: "jira:taiga", origin: .europeAndOSS,
                      name: "Taiga", homepage: URL(string: "https://taiga.io")!,
                      note: "Spain. Apache."),
              ]),
        Entry(targetBundleID: "com.atlassian.confluence",
              targetDisplayName: "Confluence",
              targetOrigin: .other,  // Atlassian, Australia
              alternatives: [
                .init(id: "confluence:outline", origin: .oss,
                      name: "Outline", homepage: URL(string: "https://www.getoutline.com")!,
                      note: "BSL. Team knowledge base."),
                .init(id: "confluence:bookstack", origin: .oss,
                      name: "BookStack", homepage: URL(string: "https://www.bookstackapp.com")!,
                      note: "MIT. Self-hostable wiki."),
              ]),
        Entry(targetBundleID: "com.basecamp.launchpad.mac",
              targetDisplayName: "Basecamp",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "basecamp:openproject", origin: .europeAndOSS,
                      name: "OpenProject", homepage: URL(string: "https://www.openproject.org")!,
                      note: "Germany. GPL."),
              ]),

        // ─── Launcher / productivity ──────────────────────────────
        Entry(targetBundleID: "com.raycast.macos",
              targetDisplayName: "Raycast",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "raycast:alfred", origin: .europe,
                      name: "Alfred", homepage: URL(string: "https://www.alfredapp.com")!,
                      note: "Running With Crayons (UK). Paid power-pack."),
                .init(id: "raycast:launchbar", origin: .europe,
                      name: "LaunchBar", homepage: URL(string: "https://obdev.at/products/launchbar/")!,
                      note: "Objective Development (Austria)."),
              ]),
        Entry(targetBundleID: "com.crowdcafe.windowmagnet",
              targetDisplayName: "Magnet",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "magnet:rectangle", origin: .oss,
                      name: "Rectangle", homepage: URL(string: "https://rectangleapp.com")!,
                      note: "MIT. Hotkey window manager."),
                .init(id: "magnet:amethyst", origin: .oss,
                      name: "Amethyst", homepage: URL(string: "https://ianyh.com/amethyst/")!,
                      note: "MIT. Tiling window manager."),
              ]),
        Entry(targetBundleID: "com.manytricks.Moom",
              targetDisplayName: "Moom",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "moom:rectangle", origin: .oss,
                      name: "Rectangle", homepage: URL(string: "https://rectangleapp.com")!,
                      note: "MIT."),
              ]),

        // ─── Terminal / dev (expanded) ────────────────────────────
        Entry(targetBundleID: "dev.warp.Warp-Stable",
              targetDisplayName: "Warp",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "warp:iterm2", origin: .oss,
                      name: "iTerm2", homepage: URL(string: "https://iterm2.com")!,
                      note: "GPL. Long-standing Mac terminal."),
                .init(id: "warp:ghostty", origin: .oss,
                      name: "Ghostty", homepage: URL(string: "https://ghostty.org")!,
                      note: "MIT. Fast GPU-accelerated terminal."),
              ]),
        Entry(targetBundleID: "com.panic.Nova",
              targetDisplayName: "Nova",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "nova:zed", origin: .oss,
                      name: "Zed", homepage: URL(string: "https://zed.dev")!,
                      note: "GPL. Fast native editor."),
                .init(id: "nova:vscodium", origin: .oss,
                      name: "VSCodium", homepage: URL(string: "https://vscodium.com")!,
                      note: "MIT."),
              ]),
        Entry(targetBundleID: "com.barebones.bbedit",
              targetDisplayName: "BBEdit",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "bbedit:neovim", origin: .oss,
                      name: "Neovim", homepage: URL(string: "https://neovim.io")!,
                      note: "Apache."),
                .init(id: "bbedit:zed", origin: .oss,
                      name: "Zed", homepage: URL(string: "https://zed.dev")!,
                      note: "GPL."),
              ]),
        Entry(targetBundleID: "com.panic.Transmit",
              targetDisplayName: "Transmit",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "transmit:cyberduck", origin: .europeAndOSS,
                      name: "Cyberduck", homepage: URL(string: "https://cyberduck.io")!,
                      note: "iterate GmbH (Germany). GPL."),
                .init(id: "transmit:filezilla", origin: .oss,
                      name: "FileZilla", homepage: URL(string: "https://filezilla-project.org")!,
                      note: "GPL."),
              ]),
        Entry(targetBundleID: "com.premiumsoft.navicat.premium",
              targetDisplayName: "Navicat",
              targetOrigin: .other,  // PremiumSoft, Hong Kong
              alternatives: [
                .init(id: "navicat:dbeaver", origin: .oss,
                      name: "DBeaver", homepage: URL(string: "https://dbeaver.io")!,
                      note: "Apache. Universal SQL client."),
                .init(id: "navicat:tableplus", origin: .other,
                      name: "TablePlus", homepage: URL(string: "https://tableplus.com")!,
                      note: "Clover Studio (Singapore). Paid, native."),
              ]),

        // ─── Media / streaming ────────────────────────────────────
        Entry(targetBundleID: "tv.plex.desktop",
              targetDisplayName: "Plex",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "plex:jellyfin", origin: .oss,
                      name: "Jellyfin", homepage: URL(string: "https://jellyfin.org")!,
                      note: "GPL. Fork of Emby with a fully-open stack."),
              ]),
        Entry(targetBundleID: "com.emby.desktop",
              targetDisplayName: "Emby",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "emby:jellyfin", origin: .oss,
                      name: "Jellyfin", homepage: URL(string: "https://jellyfin.org")!,
                      note: "GPL. Community fork, no telemetry."),
              ]),
        Entry(targetBundleID: "com.riverside.electron",
              targetDisplayName: "Riverside",
              targetOrigin: .other,   // Israel
              alternatives: [
                .init(id: "riverside:audacity", origin: .oss,
                      name: "Audacity", homepage: URL(string: "https://www.audacityteam.org")!,
                      note: "GPL."),
                .init(id: "riverside:obs", origin: .oss,
                      name: "OBS Studio", homepage: URL(string: "https://obsproject.com")!,
                      note: "GPL."),
              ]),
        Entry(targetBundleID: "com.descript.app",
              targetDisplayName: "Descript",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "descript:audacity", origin: .oss,
                      name: "Audacity", homepage: URL(string: "https://www.audacityteam.org")!,
                      note: "GPL. Multi-track editor."),
              ]),

        // ─── VPN ──────────────────────────────────────────────────
        Entry(targetBundleID: "com.nordvpn.macos",
              targetDisplayName: "NordVPN",
              targetOrigin: .other,   // Panama-registered, Nord Security is Lithuanian but opaque
              alternatives: [
                .init(id: "nord:protonvpn", origin: .europe,
                      name: "ProtonVPN", homepage: URL(string: "https://protonvpn.com")!,
                      note: "Proton AG (Switzerland). Open-source clients, WireGuard."),
                .init(id: "nord:mullvad", origin: .europe,
                      name: "Mullvad VPN", homepage: URL(string: "https://mullvad.net")!,
                      note: "Mullvad (Sweden). No-logs, flat-rate, cash-accepting."),
              ]),
        Entry(targetBundleID: "com.expressvpn.ExpressVPN",
              targetDisplayName: "ExpressVPN",
              targetOrigin: .other,   // BVI-registered, Kape Technologies (UK) since 2021
              alternatives: [
                .init(id: "evpn:protonvpn", origin: .europe,
                      name: "ProtonVPN", homepage: URL(string: "https://protonvpn.com")!,
                      note: "Switzerland."),
                .init(id: "evpn:mullvad", origin: .europe,
                      name: "Mullvad VPN", homepage: URL(string: "https://mullvad.net")!,
                      note: "Sweden."),
              ]),

        // ─── System / utilities (non-Apple-built-in) ──────────────
        Entry(targetBundleID: "com.bjango.istatmenus",
              targetDisplayName: "iStat Menus",
              targetOrigin: .other,   // Bjango, Australia
              alternatives: [
                .init(id: "istat:stats", origin: .oss,
                      name: "Stats", homepage: URL(string: "https://github.com/exelban/stats")!,
                      note: "MIT. System-monitor menu bar."),
              ]),
        Entry(targetBundleID: "com.if.Amphetamine",
              targetDisplayName: "Amphetamine",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "amph:caffeinate", origin: .oss,
                      name: "Caffeine", homepage: URL(string: "https://www.caffeine-app.net")!,
                      note: "Freeware. Prevents sleep."),
              ]),

        // ─── PDF / documents ──────────────────────────────────────
        Entry(targetBundleID: "com.adobe.Acrobat.Pro",
              targetDisplayName: "Adobe Acrobat Pro",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "acrobat:skim", origin: .oss,
                      name: "Skim", homepage: URL(string: "https://skim-app.sourceforge.io")!,
                      note: "BSD. Mac PDF reader + annotator."),
                .init(id: "acrobat:xournalpp", origin: .oss,
                      name: "Xournal++", homepage: URL(string: "https://xournalpp.github.io")!,
                      note: "GPL. Note-taking and PDF annotation."),
              ]),

        // ─── AI tools ─────────────────────────────────────────────
        Entry(targetBundleID: "ai.perplexity.mac",
              targetDisplayName: "Perplexity",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "perp:mistral", origin: .europe,
                      name: "Mistral Le Chat", homepage: URL(string: "https://chat.mistral.ai")!,
                      note: "Mistral AI (France). EU-hosted."),
                .init(id: "perp:lmstudio", origin: .oss,
                      name: "LM Studio", homepage: URL(string: "https://lmstudio.ai")!,
                      note: "Run open-weight models locally."),
              ]),
        Entry(targetBundleID: "com.microsoft.copilot",
              targetDisplayName: "Microsoft Copilot",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "copilot:mistral", origin: .europe,
                      name: "Mistral Le Chat", homepage: URL(string: "https://chat.mistral.ai")!,
                      note: "France."),
                .init(id: "copilot:lmstudio", origin: .oss,
                      name: "LM Studio", homepage: URL(string: "https://lmstudio.ai")!,
                      note: "Local inference."),
              ]),

        // ─── Games platforms ──────────────────────────────────────
        Entry(targetBundleID: "com.valvesoftware.steam",
              targetDisplayName: "Steam",
              targetOrigin: .unitedStates,
              alternatives: [
                .init(id: "steam:heroic", origin: .oss,
                      name: "Heroic Games Launcher", homepage: URL(string: "https://heroicgameslauncher.com")!,
                      note: "GPL. Epic + GOG launcher."),
                .init(id: "steam:gog", origin: .europe,
                      name: "GOG Galaxy", homepage: URL(string: "https://www.gog.com/galaxy")!,
