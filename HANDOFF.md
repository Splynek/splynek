...
**Tests:** `swift run splynek-test` (**736 tests**, all green — was 552 before S4; +184 net across S4 + 5-track sweep + 3-phase product expansion + 2026-05-08 design revolution + audit hardening) — `swift build` produces **0 warnings on clean rebuild** (verified on fresh DerivedData 2026-05-08)
**CLI:** `swift run splynek-cli version` (plus `sovereignty-dump` for catalog round-trip)

**Current version: v1.6.2 (Info.plist) / v1.5.3 (last pushed tag + uploaded DMG) — last work 2026-05-08 (whole-app design revolution + audit hardening; 14 commits since 2efa8d0).**
...
Catalog state on `main` (after v1.6.2 rounds 1–8 + v1.7→v1.9.7 i18n adds + audit-extension catch-up + 2026-05-06/07 UI/UX + catalog-coverage sweep + five-track polish 2026-05-07 + 2026-05-08 design-revolution L10n pass):
- Mac Localizable.xcstrings: **666 strings × 5 locales** (en/pt-PT/es/fr/de/it) = **3,330 translations** (+38 strings / +190 translations covering Trust gauge, Savings hero, Updates pipeline-stage labels, Install registry actions, History actions, Fleet hover, Downloads upsell, sidebar).
...
v1.8 — Verified Installer
  ...
  Sources/SplynekCore/AppUpdates/UpdateSweep.swift               ← resolver fan-out + URL preflight (2026-05-08)
