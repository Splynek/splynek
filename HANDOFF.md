...
**Tests:** `swift run splynek-test` (**808 tests**, all green — was 740 before PRO-PLUS-IPHONE Sprint 1; +68 net across Trust Watcher pure-logic + CloudKit alert record round-trip + Sprint 2 scaffolds (Migrate plan, Concierge sequence, Geo-fence policy) + Sprint 2 part-2 (Migrate review list + Concierge sequence runner) + Sprint 3 (Concierge migrate-digest handler + engagement counters / Trust+ gate)) — `swift build` produces **0 warnings on clean rebuild** (verified on fresh DerivedData 2026-05-08)
**CLI:** `swift run splynek-cli version` (plus `sovereignty-dump` for catalog round-trip)

**Current version: v1.6.2 (Info.plist) / v1.5.3 (last pushed tag + uploaded DMG) — last work 2026-05-10 evening (PRO-PLUS-IPHONE Sprint 3: Sovereignty review banner (closes Migrate-list loop with stale-week DisclosureGroup), Watch complication (3 accessory families with traffic-light Sovereignty Gauge), Concierge `migrate_review_digest` tool (9th tool — drift-guard test bumped 8 → 9), Pricing telemetry foundation (engagement counters + Trust+ gate, pure-local, 9 surface counters across Trust Watcher + Migrate + iPhone).  4 commits 85d6e4f → ec1e9d9 + docs; 808/808 tests green; iOS xcodebuild SUCCEEDED.  Plus 2026-05-10 morning Sprint 2 part-2 (4 commits 641dc70 → 9e1db78 + docs 6b4ca62) + 2026-05-09 evening Sprint 1 (5 commits 5e30f5c → fabf46e + docs 7a93885) + 2026-05-09 morning Settings decentralization (5 commits 57fb6cb → 2b3a87f) + 2026-05-08 design revolution + audit hardening + catalog growth strategy with 4,088-entry Homebrew Cask import; ~42 commits since `2efa8d0`, all pushed to `origin/rollup/2026-05-08` as backup; ~165 commits ahead of `origin/main` total).**
