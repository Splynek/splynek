...
**Current version: v1.6.2 (Info.plist) / v1.5.3 (last pushed tag + uploaded DMG) — last work 2026-05-08 (whole-app design revolution + audit hardening + catalog growth strategy with 4,088-entry Homebrew Cask import; ~21 commits since `2efa8d0`, all pushed to `origin/rollup/2026-05-08` as backup; ~140 commits ahead of `origin/main` total).**
