...
**Current version: v1.6.2 (Info.plist) / v1.5.3 (last pushed tag + uploaded DMG) — last work 2026-05-10 late night (PRO-PLUS-IPHONE Sprint 5: Raycast extension scaffold (5 commands using Sprint 4 API tokens — first concrete external client of the developer-power-up surface), iPhone Companion pairing-flow copy (recommends API tokens for stable pairing, ranks session token as fallback), L10n round 2 (+26 strings × 5 locales = 770 → 796; introduces interpolated %@ forms), SMOKE-TEST-RUNBOOK 11-section walkthrough.  5 commits 79fe846 → 6580ec0 + docs; 820/820 tests green.  Plus 2026-05-10 night Sprint 4 (4 commits 7f02266 → 088d8d1 + docs 5b137f1) + 2026-05-10 evening Sprint 3 (4 commits 85d6e4f → ec1e9d9 + docs bbd1f65) + 2026-05-10 morning Sprint 2 part-2 (4 commits 641dc70 → 9e1db78 + docs 6b4ca62) + 2026-05-09 evening Sprint 1 (5 commits 5e30f5c → fabf46e + docs 7a93885) + 2026-05-09 morning Settings decentralization (5 commits 57fb6cb → 2b3a87f) + 2026-05-08 design revolution + audit hardening + catalog growth strategy with 4,088-entry Homebrew Cask import; ~52 commits since `2efa8d0`, all pushed to `origin/rollup/2026-05-08` as backup; ~174 commits ahead of `origin/main` total.  PRO-PLUS-IPHONE arc is feature-complete on the public-repo side; remaining work is maintainer-only out-of-band + splynek-pro Concierge LLM wiring + manual smoke per `SMOKE-TEST-RUNBOOK.md`).**
